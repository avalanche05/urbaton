...
class Parking(Base):
    ...
    polygon: Mapped[List[Dict]] = mapped_column(nullable=False,
                                                type_=ARRAY(JSONB)
                                                )
    ...
    busy_disabled_spaces: Mapped[int] = mapped_column(nullable=False, default=0)
    ...
    tags: Mapped[List[str]] = mapped_column(nullable=False,
                                            type_=ARRAY(String)
                                            )
